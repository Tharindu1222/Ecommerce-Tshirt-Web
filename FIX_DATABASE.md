# Fix Database Tables - Quick Guide

You're getting 500 errors because the database tables don't exist. Follow these steps:
...
This will create all the required tables in your `zanru` database.

## Alternative: Manual SQL

If the script doesn't work, run this SQL manually:
...
3. The 500 errors should be gone and products should load!
