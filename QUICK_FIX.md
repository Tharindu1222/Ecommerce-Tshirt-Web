...
You're getting 500 errors because the database tables don't exist. Here's how to fix it:
...
## Step 2: If That Doesn't Work - Manual SQL

1. **Open MySQL Command Line or MySQL Workbench**

2. **Connect to your database** (zanru)
...
Refresh your browser - the 500 errors should be gone!
...
You should see 4 tables and 6 products.
